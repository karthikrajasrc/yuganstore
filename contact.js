(function () {
  emailjs.init("VBcYPl6MCDUv5b5Ug");
})();
...
const userinputquery = document.querySelector("#userinput-query");
  ...
  const templateParams = {
    title: "Contact Form Query",
     name: userinputname.value.trim(),
      from_name: userinputname.value.trim(),
      phone: userinputphone.value.trim(),
      message: userinputquery.value.trim()
    };
    emailjs.send(
      "service_xpdlcvs", 
      "template_6c36qoe",
